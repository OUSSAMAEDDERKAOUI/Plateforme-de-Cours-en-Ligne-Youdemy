document.getElementById('tagModal').addEventListener('submit', function(event) {
    ...
    if (!nameRegex.test(tagName)) {
        isValid = 0;
        errorMessageName = 'Le nom du tag doit contenir entre 3 et 50 caractères, avec des lettres, des chiffres et des espaces.\n';
    }

    if (!descriptionRegex.test(tagDescription)) {
        isValid = 0;
        errorMessageDesc = 'La description du tag doit contenir entre 10 et 300 caractères, avec des lettres, des chiffres, et des espaces.\n';
    }
