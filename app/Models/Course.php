...
class Course {
    ...
    public function __construct($courseTitle, $courseContent, $teacherId, $courseStatus = 'active', $creationDate = null, $courseConverture, $courses_description, $categoryId = null) {
